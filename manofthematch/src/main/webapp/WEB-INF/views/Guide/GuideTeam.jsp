...
<body>
	...
	<div class="col-xs-8 col-md-8">
		<div class="row teambox">
			...
			13.5 개인포인트 배팅<br>
			13.6 개인포인트 배팅취소<br>
			13.7 개인포인트 배팅 결과조회<br>
			14	토너먼트 일정 관리<br>
			14.1 토너먼트 일정 등록<br>
			14.2 토너먼트 일정 수정<br>
			14.3 토너먼트 일정 삭제<br>
			14.4 토너먼트 일정 조회<br>
			14.5 현재 토너먼트 결과 등록<br>
			14.6 현재 토너먼트 결과 수정<br>
			14.7 현재 토너먼트 결과 삭제<br>
			14.8 현재 토너먼트 결과 조회<br>
			14.9 지난 토너먼트 결과 등록<br>
			14.10 지난 토너먼트 결과 수정<br>
			14.11 지난 토너먼트 결과 삭제<br>
			14.12 지난 토너먼트 결과 조회<br>
			28	게시판카테고리관리<br>
			28.1 게시판카테고리수정<br>
			28.2 게시판카테고리삭제<br>
			</div>					   			
